...
export function toReview(raw: any, gameId?: string): Review {
  return {
    ...
    avatar: raw.avatar_url ?? raw.avatar ?? 'https://www.nicepng.com/png/detail/115-1150821_default-avatar-comments-sign-in-icon-png.png',
...
export function toList(raw: any): CuratedList {
  ...
  return {
    ...
    avatar: raw.avatar_url ?? raw.owner?.avatar_url ?? 'https://www.nicepng.com/png/detail/115-1150821_default-avatar-comments-sign-in-icon-png.png',
